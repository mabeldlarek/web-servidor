<section class="container">
    ...
    <a class="btn btn-primary m-4" href="/admin/carros/create">Inserir Novo</a>
    <table class="table table-bordered table-hover table-dark text-center">
        ...
        <?php foreach ($tuples as $tuple):?>
            <tr>
                ...
                <td><a class="btn btn-outline-light" href="/admin/carros/update/<?=$tuple['id_veiculo']?>"><i class="bi bi-tools"></i></a></td>
                <td><a class="btn btn-outline-light" href="/admin/carros/delete/<?=$tuple['id_veiculo']?>"><i class="bi bi-trash"></i></i></a></td>
            </tr>
        <?php endforeach;?>
        </tbody>
    </table>
