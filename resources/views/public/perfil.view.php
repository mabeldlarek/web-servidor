<section class="container">
    ...
    <form class="text-center p-4" action="/perfil/editar/salvar/<?= $_SESSION['id_usuario']?>" method="POST">
    ...
    <table class="table table-bordered table-hover table-dark text-center">
        ...
        <?php foreach ($tuples as $tuple):?>
            <tr>
                ...
                <td><a class="btn btn-outline-light" href="/perfil/editar/delete/<?=$tuple['id_emprestimo']?>"><i class="bi bi-trash"></i></a></td>
            </tr>
        <?php endforeach;?>
        </tbody>
    </table>
